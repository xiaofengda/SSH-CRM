...
<script type="text/javascript">
	$(function(){
		...
		$.post("${pageContext.request.contextPath}/baseDict_findByTypeCode.action",{"dict_type_code":"002"},function(data){
			...
			$("#cust_source option[value='${model.baseDictSource.dict_id}']").attr("selected", "selected");
		...
		$.post("${pageContext.request.contextPath}/baseDict_findByTypeCode.action",{"dict_type_code":"001"},function(data){
			...
			$("#cust_industry option[value='${model.baseDictIndustry.dict_id}']").attr("selected", "selected");
		},"json");
		...
		$.post("${pageContext.request.contextPath}/baseDict_findByTypeCode.action",{"dict_type_code":"006"},function(data){
			...
			$("#cust_level option[value='${model.baseDictLevel.dict_id}']").attr("selected", "selected");
...
<s:fielderror/>
	<FORM id="form" name="form"
		...
		method="post"  onSubmit="return check();">
		 <input type="hidden" name="cust_id" id="cust_id" value='<s:property value="cust_id"/>'>
		 <input type="hidden" name="cust_images" id="cust_images" value='<s:property value="cust_images"/>'>
						...
						<TABLE cellSpacing=0 cellPadding=5  border=0>
							...
							<TR>
								...
								<INPUT class=textbox id=sChannel2
														...
														value='<s:property value="model.cust_phone"/>'>
								</td>
								<td>移动电话 ：</td>
								<td>
								<INPUT class=textbox id=sChannel2
														style="WIDTH: 180px" maxLength=50 name="cust_mobile"
														value='<s:property value="model.cust_mobile"/>'>
								</td>
							</TR>
