<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<%-- EL    <%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c" %> --%>
										...
										<TABLE id=grid
											...
											<TBODY>
												...
												<s:iterator value="list">
													...
													<TD>
													<a href="${pageContext.request.contextPath }/customer_toUpdate.action?cust_id=<s:property value="cust_id"/>">修改</a>
													&nbsp;&nbsp;
													<a href="${pageContext.request.contextPath }/customer_deleteById.action?cust_id=<s:property value="cust_id"/>">删除</a>
													</TD>
												</TR>
												</s:iterator>
											</TBODY>
								...
								<TR>
									<TD><SPAN id=pagelink>
											<DIV
												...
												总共[<B><s:property value="tatalcount"/></B>]条记录&nbsp;[<B><s:property value="totalPage"/></B>]页
												每页显示
