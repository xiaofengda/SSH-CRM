	...
	*/
	$(function () {
		...
		$.post("${pageContext.request.contextPath}/customer_findAllCustomer.action",{},function(data){
			...
			$("#customer option[value='${customer.cust_id}']").attr("selected", "selected");
		...
		$.post("${pageContext.request.contextPath}/user_findAllUser.action",{},function(data){
			...
			$("#user option[value='${user.user_id}']").attr("selected", "selected");
...
<BODY>
	<s:form id="form1" name="form1" action="saleVisit_update" namespace="/" method="post" theme="simple">
		<s:hidden name="visit_id" id="visit_id"/>
					...
					<TD vAlign=top width="100%" bgColor=#ffffff>
						...
						<TABLE cellSpacing=0 cellPadding=5  border=0>
							...
							<TR>
								...
								<td>拜访时间：</td>
								<td>
									<s:textfield readonly="true" id="visit_time" cssClass="textbox" cssStyle="WIDTH: 184px" name="visit_time" />
								</td>
								<td>拜访地点 ：</td>
								<td>
								<s:textarea rows="3" cols="3" cssClass="textbox" id="sChannel2" cssStyle="WIDTH: 180px" maxLength="50" name="visit_addr"/>
								</td>
							</TR>
							<TR>
								<td>拜访详情 ：</td>
								<td>
								<s:textarea rows="3" cols="3" cssClass="textbox" id="sChannel2" cssStyle="WIDTH: 180px" maxLength="50" name="visit_detail"/>
								</td>
								<td>下次拜访时间 ：</td>
								<td>
								<s:textfield readonly="true" id="visit_nexttime" cssClass="textbox" cssStyle="WIDTH: 184px" maxLength="50" name="visit_nexttime"/>
								</td>
							</TR>
							<tr>
								<td rowspan=2>
