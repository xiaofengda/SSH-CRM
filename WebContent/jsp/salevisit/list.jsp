										...
										<TABLE id=grid
											...
											<TBODY>
												...
												<TR
													...
													<TD>
													<a href="${pageContext.request.contextPath }/saleVisit_toUpdate.action?visit_id=<s:property value="visit_id"/>">修改</a>
													&nbsp;&nbsp;
								...
								<TR>
									<TD><SPAN id=pagelink>
											<DIV
												...
												共[<B><s:property value="tatalcount"/></B>]条记录,[<B><s:property value="totalPage"/></B>]页
												,每页显示
