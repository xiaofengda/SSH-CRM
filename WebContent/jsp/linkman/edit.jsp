...
<BODY>
	<s:form id="form1" name="form1" action="linkman_update" namespace="/" method="post" theme="simple">
		<s:hidden name="lkm_id" id="lkm_id"/>
					...
					<TD vAlign=top width="100%" bgColor=#ffffff>
						...
						<TABLE cellSpacing=0 cellPadding=5  border=0>
							...
							<tr>
								<td>所属客户：</td>
								<td colspan="3">
									<s:select list="list" name="customer.cust_id" value="%{model.customer.cust_id}" headerKey=""
							...
							<td>联系人名称：</td>
								...
								<td>联系人性别：</td>
								<td>
									<s:radio list="#{'1':'男','2':'女' }" id="lkm_gender" name="lkm_gender" value="%{model.lkm_gender}"/>
								<td>
							</tr>
							<tr>
								<td>联系人办公电话 ：</td>
							...
							<tr>
								...
								<td>联系人备注 ：</td>
								<td>
									<s:textarea rows="3" cols="3" cssClass="textbox" id="sChannel2" name="lkm_memo" cssStyle="WIDTH: 180px" maxLength="50"/>
								</td>
							</tr>
							<tr>
								<td rowspan=2>
